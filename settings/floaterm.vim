...
nmap <silent><leader>g :FloatermNew --height=0.9 --width=0.7 --autoclose=2 lazygit<CR>
imap <silent><leader>g <C-O>:FloatermNew --height=0.9 --width=0.7 --autoclose=2 lazygit<CR>
