...
function M.setup()
  ...
  require("luasnip.loaders.from_vscode").lazy_load { paths = { "./.vim/lua-snippets/terraform" } }
  require("luasnip.loaders.from_vscode").lazy_load { paths = { "./.vim/lua-snippets/python" } }
  require("luasnip.loaders.from_vscode").lazy_load { paths = { "./.vim/lua-snippets/rust" } }
